...
public class BaseWorld {
    ...
    public void tick(){
        ...
        for( Item i: handler.getWorld().getEntityManager().getPlayer().getInventory().getInventoryItems()){
       	 if(i.getName() == ("YoshiEgg")){
       		 if(handler.getKeyManager().keyJustPressed(KeyEvent.VK_G)) {
        		 handler.getWorld().getEntityManager().addEntity(new Yoshi(handler,(int) handler.getWorld().getEntityManager().getPlayer().getX()+50,(int) handler.getWorld().getEntityManager().getPlayer().getY()+50));
