 ...
 */
public class BowserJr extends CreatureBase  {
    ...
    public BowserJr(Handler handler, float x, float y) {
    ...
    public void die() {
    	...
    	handler.getWorld().getItemManager().addItem(Item.blueMushroomItem.createNew((int) x + bounds.x, (int)y +bounds.y,1));
