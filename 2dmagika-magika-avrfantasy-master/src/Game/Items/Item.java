...
public class Item {
    ...
    public static Item skullItem = new Item(Images.skull, "Skull", 4);
    public static Item eggItem = new Item(Images.egg, "YoshiEgg", 5);
    public static Item blueMushroomItem = new Item(Images.blueMushroom, "Blue Mushroom", 6);
